...
- per-init reliable floor: 0 dB … 10 dB (median 0 dB)
- **Conservative envelope: reliable down to 10 dB across every initialization** (threshold 0.80). This is the floor that holds regardless of the training seed — the honest number to stand on.
